...
public class LaunchClassLoader extends URLClassLoader {
    ...
    public LaunchClassLoader(@NotNull URL@NotNull[] sources, ClassLoader cl) {
        super(sources, cl);
        ...
        if (DEBUG_SAVE) {
            int x = 1;
            tempFolder = new File(net.minecraft.launchwrapper.Launch.minecraftHome, "CLASSLOADER_TEMP");
    ...
    public static LaunchClassLoader createClassLoaderWithParent(@NotNull URL@NotNull[] sources, ClassLoader cl) {
        return new LaunchClassLoader(sources, cl);
    }
